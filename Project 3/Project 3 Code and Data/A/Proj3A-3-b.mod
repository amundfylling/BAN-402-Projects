...
minimumtickets_Students_and_Seniors{i in I: i <> "General"}:  #The segments students and seniors must individually make up least 10% of the venue capacity each.
	Q[i] >= 0.1*Cap;	
