# Part C model for task 1 and 2
set R; 						# Set of regions
set P; 						# Set of ports
set K; 						# Set of markets

param demand{K}; 			# demand in 1000 kg of apples in market K
param shipping_r{R, P};	 	# cost of shipping per 1000kg of apples from region r to port p
param shipping_p{P, K}; 	# cost of shipping per 1000kg of apples from port p to market k
param shipping_d{R, K}; 	# cost of shipping per 1000kg of apples directly from region r to market k
...
requirement{k in K}: 		# The sum of what enters the market must at least equal the demand
	sum{p in P}y[p,k] + sum{r in R}z[r,k] >= demand[k];
