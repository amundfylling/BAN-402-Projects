...
var y{D,H} >= 0; # State of charge on day d at hour h (ingoing balance)
...
CapacitybalanceDoD{d in D:d > 0}: # State-of-charge must be transfered from one day to another (we could have included G[d,h] but we know there is no consumption at this time)
